...
How to Access
-------------
* To get all items provided the username (e.g. chris)
  * add "/api/chris/items" to the url
* To add a new item provided the username (e.g. chris)
  * the following items are required:
    * item_name
    * price
    * quantity
  * then submit to "/api/chris/items" with the POST method
* To update the quantity of an existing item provided the username (e.g. chris)
  * the following item is required:
    * quantity
    * item_id, on the url (e.g. 1345)
  * then submit to "/api/chris/items/1345" with the PUT method
* To delete an item provided the username (e.g. chris)
  * the following item is required:
    * item_id, on the url (e.g. 2343)
  * then submit to "api/chris/items/2343" with the DELETE method
* To get total cost of a user (e.g. chris)
  * add "/api/chris/checkout" to the url
* To apply coupon code (e.g. HEywJL2D) provided the username (e.g. chris)
